...
def pos_neg_is_disjoint(pos_ctx_set: ContextSet,
    ...
    :parameter pair_symbol:  Pairsym which identifies the previously stored set of negative contexts.  Those contexts are space-separated strings of pair symbols.
